...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Cage) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require teachpack/bootstrap/cage-teachpack)
