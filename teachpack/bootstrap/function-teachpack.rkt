...
(provide-higher-order-primitive space (rocket-height))
(provide-higher-order-primitive graph (rocket-height))
(provide-higher-order-primitive everything (rocket-height))
